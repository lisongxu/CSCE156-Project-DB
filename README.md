...
You will write all the code from scratch. You are recommended to follow the JDBC lecture slides and the [JDBC project example](https://canvas.unl.edu/courses/200889/files/23040182?wrap=1) to define appropriate Java classes, such as 
