...
Users can control the visibility of their posts. Posts are always visible to the poster and can be made visible to selected users. Specifically, each user maintains a visibility list and the posts are visible to the users in the visibility list.
